...
const validarPassword2 = () => {
	...
	if(inputPassword1.value !== inputPassword2.value){
		...
		document.querySelector(`#grupo-password2 i`).classList.add('bi bi-x-circle-fill');
		...
		document.querySelector(`#grupo-password2 i`).classList.remove('bi bi-x-circle-fill');
